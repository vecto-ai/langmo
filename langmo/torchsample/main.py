...
parser.add_argument(
    "--model", type=str, default="LSTM", help="type of recurrent net (RNN_TANH, RNN_RELU, LSTM, GRU, Transformer)"
)
...
parser.add_argument(
    "--nhead", type=int, default=4, help="the number of heads in the encoder/decoder of the transformer model"
)
...
params["path_results"] = os.path.join(path_results_base, f"torchsampl_{params['model']}", f"{get_time_str()}_{hostname}")

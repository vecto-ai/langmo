...
class Callbacks(unittest.TestCase):
    ...
    def test_backward_compatibility(self):
        params = Config(name_task="test_callbacks_1", cluster_env=self.cluster_env, param_path="tests/test_params/pretraining_minimal_callback_test.yaml")
        ...
        params = Config(name_task="test_callbacks_2", cluster_env=self.cluster_env, param_path="tests/test_params/pretraining_minimal_test.yaml")
    ...
    def test_langmo_base_config_dafault_callback(self):
        params = LangmoConfig(name_task="test_callbacks_2", cluster_env=self.cluster_env, param_path="tests/test_params/minimal_callback_test.yaml")
        params["name_run"] = "test_callbacks_2"
        self.cluster_env.barrier()
...
class ExternalCallbacks(unittest.TestCase):
    ...
    def test_external(self):
        params = Config(name_task="test_callbacks_1", cluster_env=self.cluster_env, param_path="tests/test_params/pretraining_minimal_external_callback_test.yaml")
        params["name_run"] = "test_callbacks_1"
        self.cluster_env.barrier()
